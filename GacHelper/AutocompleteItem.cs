...
namespace AutocompleteMenuNS
{
    ...
    public class AutocompleteItem
    {
        ...
        public AutocompleteItem(Member member) : this()
        {
            Text = member.Name;
            _member = member;
            if (_member.isAttr)
        ...
        public EnumList _enum = null;
        public string EnumName = "";
        public AutocompleteItem(EnumList Enum,string EnumName)
        {
            _enum = Enum;
            Text = Enum.Name;
        ...
        public DefineInfo _define = null;
        public AutocompleteItem(DefineInfo define)
        {
            _define = define;
            Text = define.Name;
